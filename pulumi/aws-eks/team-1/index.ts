...
UIDeploymentDefinition.spec.template.spec.containers[0].env[0].value = pulumi.interpolate`http://${seleniumService.spec.clusterIP}:${seleniumService.spec.ports[0].port}`
