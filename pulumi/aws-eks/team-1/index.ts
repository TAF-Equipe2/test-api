...
UIDeploymentDefinition.spec.template.spec.containers[0].env[0].value = pulumi.interpolate`${seleniumService.status.loadBalancer.ingress[0].hostname}:${seleniumService.spec.ports[0].port}`
